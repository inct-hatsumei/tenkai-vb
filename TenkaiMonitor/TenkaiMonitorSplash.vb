Public NotInheritable Class TenkaiMonitorSplash

    'TODO: このフォームは、プロジェクト デザイナー ([プロジェクト] メニューの下の [プロパティ]) の [アプリケーション] タブを使用して、
    '  アプリケーションのスプラッシュ スクリーンとして簡単に設定することができます


    Private Sub TenkaiMonitorSplash_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
